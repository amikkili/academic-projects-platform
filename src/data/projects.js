...
def dice_loss(pred, target, smooth=1e-6):
  ...
  // ══════════════════════════════════════════════════════════════════════════
  // COMING SOON — UG Projects
  // ══════════════════════════════════════════════════════════════════════════

  // UG · Machine Learning
  { id: 'cs-ug-cnn-image-classification', comingSoon: true, level: 'ug', category: 'ml', difficulty: 'Intermediate', duration: '3-4 weeks', title: 'Image Classification with CNN', tech: ['Python', 'TensorFlow', 'Keras', 'OpenCV'], summary: 'Build a Convolutional Neural Network to classify images into multiple categories using the CIFAR-10 dataset.' },
  { id: 'cs-ug-stock-lstm', comingSoon: true, level: 'ug', category: 'ml', difficulty: 'Advanced', duration: '3-5 weeks', title: 'Stock Price Forecasting with LSTM', tech: ['Python', 'TensorFlow', 'Pandas', 'yfinance'], summary: 'Predict future stock prices using LSTM time-series models trained on historical market data.' },
  { id: 'cs-ug-mnist-nn', comingSoon: true, level: 'ug', category: 'ml', difficulty: 'Beginner', duration: '1-2 weeks', title: 'Handwritten Digit Recognition (MNIST)', tech: ['Python', 'PyTorch', 'NumPy', 'Matplotlib'], summary: 'Classify handwritten digits 0–9 from the MNIST dataset using a multi-layer neural network.' },
  { id: 'cs-ug-market-basket', comingSoon: true, level: 'ug', category: 'ml', difficulty: 'Intermediate', duration: '2-3 weeks', title: 'Market Basket Analysis — Apriori Algorithm', tech: ['Python', 'mlxtend', 'Pandas', 'Matplotlib'], summary: 'Discover association rules between products in a retail dataset to recommend frequently bought-together items.' },

  // UG · Web Development
  { id: 'cs-ug-react-portfolio', comingSoon: true, level: 'ug', category: 'web', difficulty: 'Beginner', duration: '1-2 weeks', title: 'Developer Portfolio Website with React', tech: ['React', 'Tailwind CSS', 'Framer Motion', 'Vite'], summary: 'A responsive single-page portfolio site with animated sections, a project showcase, and a contact form.' },
  { id: 'cs-ug-node-restapi', comingSoon: true, level: 'ug', category: 'web', difficulty: 'Intermediate', duration: '2-3 weeks', title: 'RESTful API with Node.js, Express & JWT', tech: ['Node.js', 'Express', 'MongoDB', 'JWT'], summary: 'Build a production-ready REST API with authentication, role-based access, and CRUD operations on resources.' },
  { id: 'cs-ug-php-blog', comingSoon: true, level: 'ug', category: 'web', difficulty: 'Beginner', duration: '2-3 weeks', title: 'Blog Platform with PHP & MySQL', tech: ['PHP', 'MySQL', 'HTML/CSS', 'Bootstrap'], summary: 'A classic blog CMS where admins can write and publish posts, and visitors can read and comment.' },
  { id: 'cs-ug-django-inventory', comingSoon: true, level: 'ug', category: 'web', difficulty: 'Intermediate', duration: '3-4 weeks', title: 'Inventory Management System with Django', tech: ['Python', 'Django', 'PostgreSQL', 'Bootstrap'], summary: 'Track products, stock levels, suppliers, and sales reports in a Django-powered web application.' },

  // UG · Data Science
  { id: 'cs-ug-covid-analysis', comingSoon: true, level: 'ug', category: 'data', difficulty: 'Beginner', duration: '1-2 weeks', title: 'COVID-19 Global Trend Analysis', tech: ['Python', 'Pandas', 'Matplotlib', 'Seaborn'], summary: 'Analyze global COVID-19 case, death, and vaccination trends with interactive visualizations.' },
  { id: 'cs-ug-sales-dashboard', comingSoon: true, level: 'ug', category: 'data', difficulty: 'Intermediate', duration: '2-3 weeks', title: 'Interactive Sales Dashboard with Plotly & Dash', tech: ['Python', 'Plotly', 'Dash', 'Pandas'], summary: 'Build a live, filterable business dashboard showing KPIs, trend charts, and regional breakdowns.' },
  { id: 'cs-ug-regression-comparison', comingSoon: true, level: 'ug', category: 'data', difficulty: 'Beginner', duration: '1-2 weeks', title: 'Regression Analysis — Linear vs Polynomial', tech: ['Python', 'scikit-learn', 'Matplotlib', 'NumPy'], summary: 'Compare linear and polynomial regression models on real datasets and understand underfitting vs overfitting.' },
  { id: 'cs-ug-hr-attrition', comingSoon: true, level: 'ug', category: 'data', difficulty: 'Intermediate', duration: '2-3 weeks', title: 'HR Employee Attrition Analysis', tech: ['Python', 'Pandas', 'scikit-learn', 'Seaborn'], summary: 'Predict which employees are likely to leave using ML on the IBM HR Analytics dataset.' },

  // UG · IoT & Embedded
  { id: 'cs-ug-rpi-energy', comingSoon: true, level: 'ug', category: 'iot', difficulty: 'Intermediate', duration: '3-4 weeks', title: 'Smart Home Energy Monitor with Raspberry Pi', tech: ['Raspberry Pi', 'Python', 'InfluxDB', 'Grafana'], summary: 'Monitor and log home power consumption in real time with a Pi, current sensors, and a Grafana dashboard.' },
  { id: 'cs-ug-voice-home', comingSoon: true, level: 'ug', category: 'iot', difficulty: 'Intermediate', duration: '3-4 weeks', title: 'Voice-Controlled Home Automation', tech: ['Raspberry Pi', 'Python', 'speech_recognition', 'GPIO'], summary: 'Control household appliances using voice commands processed locally on a Raspberry Pi.' },
  { id: 'cs-ug-pulse-monitor', comingSoon: true, level: 'ug', category: 'iot', difficulty: 'Beginner', duration: '2-3 weeks', title: 'Pulse Rate Monitor with Arduino', tech: ['Arduino', 'Pulse Sensor', 'LCD', 'Processing'], summary: 'Build a wearable heart rate monitor that displays BPM on an LCD and alerts on abnormal values.' },

  // UG · Cybersecurity
  { id: 'cs-ug-aes-encryption', comingSoon: true, level: 'ug', category: 'security', difficulty: 'Intermediate', duration: '2-3 weeks', title: 'AES File Encryption & Decryption Tool', tech: ['Python', 'PyCryptodome', 'Tkinter'], summary: 'Encrypt and decrypt files using AES-256 with a password-derived key — built as a desktop GUI application.' },
  { id: 'cs-ug-port-scanner', comingSoon: true, level: 'ug', category: 'security', difficulty: 'Intermediate', duration: '2-3 weeks', title: 'Port Scanner & Vulnerability Detector', tech: ['Python', 'socket', 'Nmap', 'threading'], summary: 'Scan a target IP for open ports, banner-grab services, and map common vulnerabilities — for authorized systems only.' },
  { id: 'cs-ug-phishing-detector', comingSoon: true, level: 'ug', category: 'security', difficulty: 'Intermediate', duration: '2-3 weeks', title: 'Phishing URL Detector using ML', tech: ['Python', 'scikit-learn', 'XGBoost', 'Flask'], summary: 'Train a classifier on URL features (length, HTTPS, domain age) to detect phishing sites in real time.' },

  // UG · Mobile Apps
  { id: 'cs-ug-android-quiz', comingSoon: true, level: 'ug', category: 'mobile', difficulty: 'Beginner', duration: '2-3 weeks', title: 'Quiz App for Android (Java/Kotlin)', tech: ['Kotlin', 'Android Studio', 'SQLite', 'Material UI'], summary: 'A multi-category quiz app with timed questions, score tracking, and a leaderboard — built natively for Android.' },
  { id: 'cs-ug-rn-food-delivery', comingSoon: true, level: 'ug', category: 'mobile', difficulty: 'Intermediate', duration: '4-5 weeks', title: 'Food Delivery App with React Native', tech: ['React Native', 'Expo', 'Firebase', 'Redux'], summary: 'A cross-platform food ordering app with restaurant listings, cart, order tracking, and Firebase auth.' },
  { id: 'cs-ug-firebase-chat', comingSoon: true, level: 'ug', category: 'mobile', difficulty: 'Intermediate', duration: '2-3 weeks', title: 'Real-Time Chat App with Firebase', tech: ['Flutter', 'Firebase', 'Firestore', 'Cloud Messaging'], summary: 'A WhatsApp-style chat app with real-time messaging, online status, and push notifications via Firebase.' },
  { id: 'cs-ug-offline-notes', comingSoon: true, level: 'ug', category: 'mobile', difficulty: 'Beginner', duration: '2-3 weeks', title: 'Notes App with Offline-First Sync', tech: ['React Native', 'SQLite', 'AsyncStorage', 'Expo'], summary: 'A note-taking app that works fully offline and syncs to the cloud automatically when connectivity returns.' },

  // ══════════════════════════════════════════════════════════════════════════
  // COMING SOON — PG Projects
  // ══════════════════════════════════════════════════════════════════════════

  // PG · Machine Learning
  { id: 'cs-pg-transformer-forecast', comingSoon: true, level: 'pg', category: 'ml', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Time Series Forecasting with Transformer', tech: ['Python', 'PyTorch', 'HuggingFace', 'Pandas'], summary: 'Apply the Temporal Fusion Transformer architecture to multi-horizon energy demand forecasting.' },
  { id: 'cs-pg-gnn-social', comingSoon: true, level: 'pg', category: 'ml', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Graph Neural Networks for Social Network Analysis', tech: ['Python', 'PyTorch Geometric', 'NetworkX', 'DGL'], summary: 'Use GNN to predict community membership and detect fake accounts in large-scale social graphs.' },
  { id: 'cs-pg-rl-trading', comingSoon: true, level: 'pg', category: 'ml', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Reinforcement Learning for Algorithmic Trading', tech: ['Python', 'Stable-Baselines3', 'Gym', 'Pandas'], summary: 'Train a DQN / PPO agent to make buy/sell decisions on stock data, evaluated against a benchmark strategy.' },

  // PG · Web Development
  { id: 'cs-pg-microservices', comingSoon: true, level: 'pg', category: 'web', difficulty: 'Advanced', duration: '8-10 weeks', title: 'Microservices Architecture with Docker & Kubernetes', tech: ['Node.js', 'Docker', 'Kubernetes', 'RabbitMQ'], summary: 'Decompose a monolith into microservices, containerize them, and orchestrate with Kubernetes on a local cluster.' },
  { id: 'cs-pg-fastapi-ml', comingSoon: true, level: 'pg', category: 'web', difficulty: 'Advanced', duration: '4-6 weeks', title: 'ML Model Serving API with FastAPI & Docker', tech: ['Python', 'FastAPI', 'Docker', 'Redis', 'Celery'], summary: 'Build a production-grade REST API that serves ML predictions with async workers, caching, and monitoring.' },
  { id: 'cs-pg-graphql-saas', comingSoon: true, level: 'pg', category: 'web', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Multi-Tenant SaaS with GraphQL & PostgreSQL', tech: ['Node.js', 'GraphQL', 'PostgreSQL', 'Prisma', 'Next.js'], summary: 'Build a multi-tenant SaaS platform with row-level security, subscription billing, and a GraphQL API.' },
  { id: 'cs-pg-django-rest', comingSoon: true, level: 'pg', category: 'web', difficulty: 'Advanced', duration: '4-5 weeks', title: 'Django REST Framework — Advanced API Design', tech: ['Python', 'Django', 'DRF', 'Celery', 'Redis'], summary: 'Design and build a scalable REST API with rate limiting, background tasks, full-text search, and API versioning.' },

  // PG · Data Science
  { id: 'cs-pg-spark-bigdata', comingSoon: true, level: 'pg', category: 'data', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Big Data Analytics with Apache Spark', tech: ['Apache Spark', 'PySpark', 'Hadoop', 'Hive'], summary: 'Process and analyze a 10GB+ dataset using Spark RDDs and DataFrames, and build an ML pipeline with MLlib.' },
  { id: 'cs-pg-bayesian', comingSoon: true, level: 'pg', category: 'data', difficulty: 'Advanced', duration: '5-6 weeks', title: 'Bayesian Statistical Inference with PyMC', tech: ['Python', 'PyMC', 'ArviZ', 'NumPy', 'Matplotlib'], summary: 'Apply Bayesian methods with MCMC sampling to model uncertainty in A/B tests and clinical trial data.' },
  { id: 'cs-pg-etl-pipeline', comingSoon: true, level: 'pg', category: 'data', difficulty: 'Advanced', duration: '5-7 weeks', title: 'ETL Pipeline for Business Intelligence (Airflow + dbt)', tech: ['Apache Airflow', 'dbt', 'PostgreSQL', 'Metabase'], summary: 'Build a scheduled ETL pipeline from raw CSV to cleaned data warehouse with dbt models and Airflow DAGs.' },
  { id: 'cs-pg-realtime-analytics', comingSoon: true, level: 'pg', category: 'data', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Real-Time Streaming Analytics with Kafka & Flink', tech: ['Apache Kafka', 'Apache Flink', 'Python', 'Elasticsearch'], summary: 'Stream clickstream events through Kafka, process them with Flink, and visualize in Kibana dashboards.' },

  // PG · IoT & Embedded
  { id: 'cs-pg-edge-ai', comingSoon: true, level: 'pg', category: 'iot', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Edge AI Inference on Raspberry Pi with TFLite', tech: ['Raspberry Pi', 'TensorFlow Lite', 'Python', 'OpenCV'], summary: 'Deploy a quantized MobileNet model to a Raspberry Pi for real-time object classification at the edge.' },
  { id: 'cs-pg-precision-agri', comingSoon: true, level: 'pg', category: 'iot', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Precision Agriculture with Drone & Multi-Sensor Fusion', tech: ['Raspberry Pi', 'NDVI Camera', 'MQTT', 'Python', 'ML'], summary: 'Fuse aerial NDVI imagery with ground sensor data to predict crop health and irrigation needs.' },
  { id: 'cs-pg-ecg-processing', comingSoon: true, level: 'pg', category: 'iot', difficulty: 'Advanced', duration: '5-7 weeks', title: 'ECG Signal Processing for Arrhythmia Detection', tech: ['Python', 'SciPy', 'TensorFlow', 'Arduino', 'AD8232'], summary: 'Acquire ECG signals with an AD8232 sensor, process them with DSP filters, and classify arrhythmias with a CNN.' },

  // PG · Cybersecurity
  { id: 'cs-pg-zero-trust', comingSoon: true, level: 'pg', category: 'security', difficulty: 'Advanced', duration: '8-10 weeks', title: 'Zero-Trust Network Architecture Implementation', tech: ['Linux', 'WireGuard', 'Nginx', 'OAuth2', 'Docker'], summary: 'Design and implement a Zero-Trust network where every request is authenticated and authorized regardless of source.' },
  { id: 'cs-pg-homomorphic-enc', comingSoon: true, level: 'pg', category: 'security', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Homomorphic Encryption for Privacy-Preserving ML', tech: ['Python', 'TenSEAL', 'PyTorch', 'CKKS'], summary: 'Train and run logistic regression on encrypted data using CKKS scheme — computation without decryption.' },
  { id: 'cs-pg-pentest-auto', comingSoon: true, level: 'pg', category: 'security', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Penetration Testing Automation Framework', tech: ['Python', 'Metasploit', 'Nmap', 'SQLmap', 'Burp Suite'], summary: 'Automate reconnaissance, vulnerability scanning, and exploitation steps in a controlled lab environment.' },
  { id: 'cs-pg-dynamic-malware', comingSoon: true, level: 'pg', category: 'security', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Dynamic Malware Analysis Sandbox', tech: ['Python', 'Cuckoo Sandbox', 'VirtualBox', 'Yara'], summary: 'Build an automated sandbox that executes suspected malware and reports behavioral artifacts (API calls, network, files).' },

  // PG · Mobile Apps
  { id: 'cs-pg-flutter-ehr', comingSoon: true, level: 'pg', category: 'mobile', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Electronic Health Record App with Flutter', tech: ['Flutter', 'Dart', 'Firebase', 'HL7 FHIR'], summary: 'A HIPAA-aware EHR mobile app supporting patient records, appointments, and HL7 FHIR data exchange.' },
  { id: 'cs-pg-ar-navigation', comingSoon: true, level: 'pg', category: 'mobile', difficulty: 'Advanced', duration: '5-7 weeks', title: 'AR Campus Navigation App for Android', tech: ['Kotlin', 'ARCore', 'Android Studio', 'Google Maps SDK'], summary: 'Augmented-reality indoor navigation that overlays directional arrows on the camera view to guide users.' },
  { id: 'cs-pg-telemedicine', comingSoon: true, level: 'pg', category: 'mobile', difficulty: 'Advanced', duration: '6-8 weeks', title: 'Telemedicine App with WebRTC Video Calls', tech: ['React Native', 'WebRTC', 'Node.js', 'Socket.io', 'Firebase'], summary: 'A secure telemedicine platform with real-time video consultation, e-prescriptions, and medical record storage.' },

  // ══════════════════════════════════════════════════════════════════════════
  // COMING SOON — School Projects
  // ══════════════════════════════════════════════════════════════════════════

  // School · Machine Learning
  { id: 'cs-sc-teachable-machine', comingSoon: true, level: 'school', category: 'ml', difficulty: 'Beginner', duration: '1 week', title: 'Image Classifier with Teachable Machine', tech: ['Teachable Machine', 'HTML', 'JavaScript', 'TensorFlow.js'], summary: 'Train a no-code image classifier using Google Teachable Machine and embed it in a web page — zero Python needed.' },
  { id: 'cs-sc-grade-predictor', comingSoon: true, level: 'school', category: 'ml', difficulty: 'Beginner', duration: '1 week', title: 'Grade Predictor using Linear Regression', tech: ['Python', 'scikit-learn', 'Matplotlib'], summary: 'Predict your exam score from study hours using the simplest ML algorithm — linear regression — with a visual plot.' },
  { id: 'cs-sc-spam-sms', comingSoon: true, level: 'school', category: 'ml', difficulty: 'Beginner', duration: '1-2 weeks', title: 'SMS Spam Detector with Naive Bayes', tech: ['Python', 'scikit-learn', 'NLTK', 'Pandas'], summary: 'Classify SMS messages as spam or ham using a Naive Bayes text classifier on the UCI SMS dataset.' },

  // School · Web Development
  { id: 'cs-sc-portfolio', comingSoon: true, level: 'school', category: 'web', difficulty: 'Beginner', duration: '1 week', title: 'Personal Portfolio Website (HTML & CSS)', tech: ['HTML', 'CSS', 'JavaScript'], summary: 'Build your own portfolio page showcasing your name, photo, skills, and projects with a stylish CSS layout.' },
  { id: 'cs-sc-quiz-web', comingSoon: true, level: 'school', category: 'web', difficulty: 'Beginner', duration: '1 week', title: 'Interactive Quiz Web App', tech: ['HTML', 'CSS', 'JavaScript'], summary: 'A multiple-choice quiz game that keeps score, shows correct answers, and has a timer per question.' },

  // School · Data Science
  { id: 'cs-sc-marks-chart', comingSoon: true, level: 'school', category: 'data', difficulty: 'Beginner', duration: '1 week', title: 'Class Marks Analysis with Matplotlib', tech: ['Python', 'Matplotlib', 'Pandas'], summary: 'Read classmates\' exam scores from a CSV, compute stats (average, highest, lowest), and plot bar and pie charts.' },
  { id: 'cs-sc-survey-eda', comingSoon: true, level: 'school', category: 'data', difficulty: 'Beginner', duration: '1 week', title: 'Your Own Survey — EDA in Python', tech: ['Python', 'Pandas', 'Seaborn'], summary: 'Collect a small survey, clean it in pandas, and create visualizations that tell a story about your class/community.' },

  // School · IoT & Embedded
  { id: 'cs-sc-traffic-light', comingSoon: true, level: 'school', category: 'iot', difficulty: 'Beginner', duration: '1 week', title: 'Traffic Light Simulator with Arduino', tech: ['Arduino', 'LEDs', 'Resistors', 'Tinkercad'], summary: 'Simulate a traffic light sequence using three LEDs and Arduino — your very first hardware + code project.' },
  { id: 'cs-sc-temp-sensor', comingSoon: true, level: 'school', category: 'iot', difficulty: 'Beginner', duration: '1 week', title: 'Temperature & Humidity Display with Arduino', tech: ['Arduino', 'DHT11', 'LCD 16x2', 'C++'], summary: 'Connect a DHT11 sensor to Arduino and display live temperature and humidity readings on an LCD screen.' },
  { id: 'cs-sc-soil-moisture', comingSoon: true, level: 'school', category: 'iot', difficulty: 'Beginner', duration: '1 week', title: 'Soil Moisture Meter with Arduino', tech: ['Arduino', 'Soil Sensor', 'Buzzer', 'LED'], summary: 'Build a plant watering alert system that beeps and lights up when soil moisture falls below a threshold.' },
  { id: 'cs-sc-ir-obstacle', comingSoon: true, level: 'school', category: 'iot', difficulty: 'Beginner', duration: '1 week', title: 'Obstacle Detector with IR Sensor & Arduino', tech: ['Arduino', 'IR Sensor', 'Buzzer', 'LED'], summary: 'Detect nearby obstacles with an infrared sensor and trigger a buzzer alert — the foundation of robot navigation.' },

  // School · Cybersecurity
  { id: 'cs-sc-caesar-cipher', comingSoon: true, level: 'school', category: 'security', difficulty: 'Beginner', duration: '1 week', title: 'Caesar Cipher Encoder / Decoder', tech: ['Python'], summary: 'Implement the ancient Caesar shift cipher in Python — encode secret messages and crack them by brute-force.' },
  { id: 'cs-sc-password-checker', comingSoon: true, level: 'school', category: 'security', difficulty: 'Beginner', duration: '1 week', title: 'Password Strength Checker', tech: ['Python', 'regex', 'Tkinter'], summary: 'Analyse a password for length, uppercase, digits, and symbols and display a strength meter — Weak to Strong.' },
  { id: 'cs-sc-login-monitor', comingSoon: true, level: 'school', category: 'security', difficulty: 'Beginner', duration: '1 week', title: 'Login Attempt Monitor in Python', tech: ['Python', 'SQLite', 'logging'], summary: 'Build a simple authentication system that locks an account after 3 failed attempts and logs all events to a file.' },

  // School · Mobile Apps
  { id: 'cs-sc-flutter-converter', comingSoon: true, level: 'school', category: 'mobile', difficulty: 'Beginner', duration: '1 week', title: 'Unit Converter App with Flutter', tech: ['Flutter', 'Dart'], summary: 'Convert length, weight, temperature, and speed units in a clean Flutter mobile app — your first Flutter project.' },
  { id: 'cs-sc-firebase-noticeboard', comingSoon: true, level: 'school', category: 'mobile', difficulty: 'Beginner', duration: '1-2 weeks', title: 'School Noticeboard App with Firebase', tech: ['Flutter', 'Firebase', 'Firestore'], summary: 'A mobile notice board where teachers post announcements and students see them in real time via Firebase.' },
  { id: 'cs-sc-flashcards', comingSoon: true, level: 'school', category: 'mobile', difficulty: 'Beginner', duration: '1 week', title: 'Flashcard Study App', tech: ['React Native', 'AsyncStorage', 'Expo'], summary: 'Create digital study flashcards, flip them to reveal answers, and track which cards you have mastered.' },
]
